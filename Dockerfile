...
RUN VITE_ENABLE_PREVIEW_MOCK_AUTH=false pnpm exec vite build --mode production && \
    ! grep -R -F "coderushoj-local-preview" dist
...
LABEL org.opencontainers.image.title="CodeRushOJ Frontend" \
      ...
      org.opencontainers.image.source="https://github.com/CodeRushOJ/croj-frontend" \
